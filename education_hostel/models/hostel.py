...
class EducationHostel(models.Model):
    ...
    hostel_name = fields.Char(string="Name", required=True, track_visibility='onchange')
    hostel_code = fields.Char(string="Code", required=True, track_visibility='onchange')
    ...
    room_rent = fields.Char(string="Room Rent", required=True, track_visibility='onchange')
    mess_fee = fields.Char(string="Mess Fee", required=True, track_visibility='onchange')
