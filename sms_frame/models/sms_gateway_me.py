...
class SmsGatewayME(models.Model):
    ...
    def send_message(self, sms_gateway_id, from_number, to_number, sms_content, my_model_name='', my_record_id=0,
        ...
        # send the sms/mms
        payload = {'number': format_to, 'message': sms_content, 'device_id': '77669', 'email': 'dmashraf@gmail.com',
                   'password': 'asraf123'}
        ...
        response_string = requests.post("https://smsgateway.me/api/v4/message/send", data=payload, )
